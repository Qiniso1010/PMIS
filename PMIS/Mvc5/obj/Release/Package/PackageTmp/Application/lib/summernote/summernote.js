    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row-fluid note-group-select-from-files">' +
                   ...
                   '</div>';
        var footer = '<button href="#" class="btn btn-success btn-custom btn-flat note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
      ...
      link: function (lang, options) {
        ...
        var footer = '<button href="#" class="btn btn-success btn-custom btn-flat note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
