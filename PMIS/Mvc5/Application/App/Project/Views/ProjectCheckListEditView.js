 var ProjectCheckListEditView = Backbone.View.extend({
    template: Template('Project/ProjectCheckListEditView'),
    initialize: function() {
        NProgress.done();
    ...
    render: function() {
        ...
        this.$('#keterangan').summernote({
          ...
          onImageUpload: function(files,editor,welEditable) {
              this.view = new ProjectCheckListEditView();
    ...
    Nav:function() {
        var template = Template('Project/_partial/ProjectCheckListEditNav');
    ...
    SaveProject:function(e) {
        ...
        $options.url = "/Project/CheckLists/Edit/";
        $options.type = "POST";
        $options.cache = false;
        $options.data = param;
