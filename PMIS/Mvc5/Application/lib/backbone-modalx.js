...
(function(){
  ...
  Backbone.ModalxView = Backbone.View.extend({
    className: "modal backbone-modal",
    template: _.template([
      '<div class="modal-dialog" style="width:920px !important">',
    ...
    buttonTemplate: _.template('<a href="<%=href%>" class="btn <%=className%> btn-custom btn-flat"><%=label%></a>'),
    buttonDefaults: {
      className: "",
      href: "javascript:;",
      label: "",
