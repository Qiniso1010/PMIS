...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="input-group"><div class="pull-' + this.options.searchAlign + ' search" id="search">',
                    sprintf('<input style="width: 300px;" class="form-control' + (this.options.iconSize == undefined ? '' :  ' input-' + this.options.iconSize)  + '" type="text" placeholder="%s">',
                        this.options.formatSearch()),
                '</div><span class="input-group-btn"><button id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i></button></span></div>');
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            '<div class="pull-right pagination">',
                '<ul class="pagination' + (this.options.iconSize == undefined ? '' :  ' pagination-' + this.options.iconSize)  + '">',
                    '<li class="page-first"><a href="javascript:void(0)">← First</a></li>',
        ...
        html.push(
                    ...
                    '<li class="page-last"><a href="javascript:void(0)">Last →</a></li>',
                '</ul>',
            '</div>');
